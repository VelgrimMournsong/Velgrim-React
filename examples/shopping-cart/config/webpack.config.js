...
const getNodeModulePath = (filePath) => path.join(process.cwd(), 'node_modules/', filePath);
...
module.exports = function(webpackEnv) {
    ...
    return {
        ...
        resolve: {
            ...
            alias: {
                "@emotion/react": getNodeModulePath("@emotion/react"),
                "@emotion/styled": getNodeModulePath("@emotion/styled"),
                "@emotion/core": getNodeModulePath("@emotion/react"),
                "emotion-theming": getNodeModulePath("@emotion/react"),
                react: getNodeModulePath('react'),
                'react-dom': getNodeModulePath('react-dom'),
